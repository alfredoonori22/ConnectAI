...
def BlueMove(clientid, cuboidH):
    ...
    time.sleep(0.2)
    move_L(clientid, g.target, [0.89, -0.675, 0.57, g.PI, 0, 0], g.velocity)
    time.sleep(0.2)
    Gripper(clientid, 0)
    time.sleep(0.2)
    ...
    time.sleep(0.2)
    move_L(clientid, g.target, [0.703, -0.675, 1.0, 0, -g.PI / 2, 0], g.velocity)
    time.sleep(0.2)
    move_L(clientid, g.target, [0.703, -0.675, 0.755, 0, -g.PI / 2, 0], g.velocity)
    time.sleep(0.5)
    Gripper(clientid, 1)
    sim.simxSetObjectParent(clientid, cuboidH, g.connector, True, sim.simx_opmode_blocking)
    time.sleep(0.5)
    move_L(clientid, g.target, [0.703, -0.675, 1.1, 0, -g.PI / 2, 0], g.velocity)


def OrangeMove(clientid, cuboidH):
    move_L(clientid, g.target, [-0.7, -0.47, 1.0, 0, 0, g.PI / 2], g.velocity)
    time.sleep(0.2)
    move_L(clientid, g.target, [-0.7, -0.47, 0.565, 0, 0, g.PI / 2], g.velocity)
    time.sleep(0.2)
    Gripper(clientid, 0)
    time.sleep(0.2)
    sim.simxSetObjectParent(clientid, cuboidH, -1, True, sim.simx_opmode_blocking)
    time.sleep(0.5)
    move_L(clientid, g.target, [-0.7, -0.47, 0.7, 0, 0, g.PI / 2], g.velocity)
    time.sleep(0.2)
    move_L(clientid, g.target, [-0.679, -0.68, 1.0, 0, -g.PI / 2, 0], g.velocity)
    time.sleep(0.2)
    move_L(clientid, g.target, [-0.679, -0.68, 0.755, 0, -g.PI / 2, 0], g.velocity)
    time.sleep(0.5)
    Gripper(clientid, 1)
    sim.simxSetObjectParent(clientid, cuboidH, g.connector, True, sim.simx_opmode_blocking)
    time.sleep(0.5)
    move_L(clientid, g.target, [-0.679, -0.68, 1.1, 0, -g.PI / 2, 0], g.velocity)
...
def moveBlockFunc(clientid, cuboid, position, color):
    ...
    time.sleep(0.2)
    move_L(clientid, g.target, [position[0], position[1], 0.755, 0, -g.PI/2, 0], g.velocity)
    time.sleep(0.5)
    Gripper(clientid, 1)
    sim.simxSetObjectParent(clientid, cuboidH, g.connector, True, sim.simx_opmode_blocking)
    time.sleep(0.5)
